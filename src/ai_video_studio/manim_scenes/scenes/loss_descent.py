"""Loss descent demo scene - visualizing gradient descent optimization."""
...
def get_loss_descent_narration_segment() -> ScriptSegment:
    ...
    return ScriptSegment(
        ...
        text=(
            "When we optimize a model's loss, we're really trying to move its "
            "parameters downhill on a surface. Lower loss is simply lower height."
        ),
    )
